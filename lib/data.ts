...
export const playbooks: Playbook[] = [
  {
    ...
    excerpt:
      "The path into tech sales is more accessible than you think. Unlike finance or consulting, there's no target school list. What matters: coachability, grit, and the ability to demonstrate you can sell. Here's how to prove it before you're even hired...",
  },
  {
    slug: "cold-calling",
    ...
    longDescription:
      "Master the art and science of cold calling. This guide covers everything from pre-call research to opening lines that work, objection handling frameworks, and the psychology of getting prospects to say yes. Includes word-for-word scripts tested across thousands of dials.",
    price: 59,
    icon: "phone",
    contents: [
    ...
    excerpt:
      "The first 7 seconds determine everything. Skip the 'How are you today?' opener—it screams sales call. Instead, lead with pattern interrupt: 'Hey [Name], we haven't spoken before, mind if I tell you why I'm calling?' Then pause. Let them respond...",
  },
  {
    ...
    longDescription:
      "A comprehensive guide to modern outbound prospecting across email, LinkedIn, phone, and video. Learn how to build sequences that actually get responses, personalization at scale, and the metrics that matter. Includes 20+ proven templates.",
    price: 59,
    icon: "mail",
    contents: [
    ...
    excerpt:
      "Your first email should be 50-75 words max. Three components: (1) Why you're reaching out to THEM specifically, (2) One sentence of value, (3) Low-friction CTA. That's it. No 'I hope this email finds you well.' No company history. Get to the point...",
  },
  {
    ...
    longDescription:
      "Transform your discovery calls from interrogations into valuable conversations. Master MEDDIC, SPIN, and modern qualification frameworks. Learn to uncover pain points, identify decision-makers, and position your solution—all while building genuine rapport.",
    price: 69,
    icon: "search",
    contents: [
    ...
    excerpt:
      "Stop asking 'What's your biggest challenge?' Everyone asks that. Instead: 'Walk me through what happens when [specific problem] occurs on your team.' This gets you stories, not soundbites. Stories reveal the real pain and who feels it most...",
  },
  {
    slug: "sdr-to-ae",
    ...
    longDescription:
      "Your roadmap from setting meetings to closing deals. This guide covers exactly what managers look for in AE candidates, how to build closing skills while still an SDR, internal positioning tactics, and how to ace AE interviews—whether internal or external.",
    price: 79,
    icon: "trending-up",
    contents: [
    ...
    excerpt:
      "The average SDR-to-AE promotion takes 12-18 months. But top performers do it in 9-12. The difference isn't just hitting quota—it's demonstrating closing instincts. Start by asking your AEs: 'Can I sit in on your next discovery call?' Then debrief...",
  },
  {
    ...
    excerpt:
      "Enterprise deals are won in the white space between calls. While your competitor waits for the next scheduled meeting, you're sending your champion the ROI deck they need to convince their CFO. The deal is always moving—with you or without you...",
  },
  {
    slug: "closing",
    ...
    excerpt:
      "Never ask 'Is there anything else you need to make a decision?' Instead: 'Based on our conversations, it sounds like we've addressed [X, Y, Z]. What would need to be true for you to move forward this month?' Specificity creates momentum...",
  },
  {
    ...
    longDescription:
      "Your complete guide to maximizing compensation in tech sales. Understand OTE structures, base vs. variable splits, equity packages, and accelerators. Learn exactly when and how to negotiate—and when to walk away.",
    price: 49,
    icon: "dollar-sign",
    contents: [
    ...
    excerpt:
      "OTE means nothing without understanding quota attainment rates. Ask: 'What percentage of the team hit quota last year?' If they dodge, that's your answer. A $200K OTE with 30% attainment is a $120K job. Know the real number before you negotiate...",
  },
]
...
export const services: Service[] = [
  {
    ...
    title: "Resume Review",
    description:
      "Detailed feedback on your resume with specific suggestions optimized for tech sales roles. We identify weaknesses in positioning, metrics, and narrative—then show you exactly how to fix them.",
    price: 197,
    turnaround: "3-5 days",
    includes: [
  ...
  },
  {
    ...
    description:
      "Complete resume transformation for tech sales. We rebuild your resume from scratch using frameworks that get callbacks from top SaaS companies—regardless of your background.",
    price: 597,
